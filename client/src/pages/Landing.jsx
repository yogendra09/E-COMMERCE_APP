        ...
        <div>
            <div className="bg-white">
                        ...
                        <div className="grid lg:grid-cols-2 items-center gap-10">
                            ...
                            <div className="grid sm:grid-cols-2 gap-8">
                                <div className="text-center bg-white shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] transition-all rounded-xl p-6">
                                    ...
                                    <a href="javascript:void(0);" className="text-blue-600 font-bold inline-block hover:underline">Learn more</a>
                                </div>
                ...
                <footer className="mt-28">
                    <div className="px-4 sm:px-10">
                        <div className="grid max-sm:grid-cols-1 max-xl:grid-cols-2 xl:grid-cols-5 gap-8 max-w-7xl mx-auto">
                            <div className="xl:col-span-2">
                                <a href="javascript:void(0)"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" className="w-40 mb-6" />
                                </a>
                            ...
                            <div>
                                ...
                                <ul className="space-y-4">
                                    <li><a href="javascript:void(0)" className="hover:text-blue-600 flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[10px] -rotate-90" viewBox="0 0 24 24">
                    ...
                    <hr className="my-6" />
                    <p className="text-center mb-6">© 2023<a href="https://readymadeui.com/" target="_blank" className="hover:underline mx-1">ReadymadeUI</a>All Rights Reserved.</p>
                </footer>
            </div>
        </div>
