        ...
        <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
          ...
          <form>
            ...
            {errors.filter((item) => (item.startsWith("INVALID_ID"))).length > 0 && 
              <><br/><div className="error">{errors.filter((item) => (item.startsWith("INVALID_ID")))[0].replace("INVALID_ID_", "")} is not a valid bond</div></>}
            {errors.filter((item) => !(item.startsWith("INVALID_ID"))).length > 0 && 
              <div className="error">Please input {errors.filter((item) => !(item.startsWith("INVALID_ID"))).join(", ")}</div>}
